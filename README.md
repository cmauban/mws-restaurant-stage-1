...
This client application should work offline, pull restaurant data from the development server, parse the JSON response, and use the information to render the appropriate sections of the application UI. It should maintain a responsive design on mobile, tablet and desktop viewports.
